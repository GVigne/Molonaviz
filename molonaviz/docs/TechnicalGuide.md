...
By default, the backend functions use snake case (snake_case), whereas as frontend functions use camel case (camelCase).
...
Frontend/end user: what is allowed, which method is called
Backend/frontned: what is allowed, which method is called
