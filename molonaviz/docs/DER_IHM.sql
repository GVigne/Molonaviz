--
-- File generated with SQLiteStudio v3.3.3 on Sun Jun 26 17:13:10 2022
--
...
CREATE TABLE RawMeasuresPress (ID INTEGER UNIQUE PRIMARY KEY AUTOINCREMENT, Date DATETIME NOT NULL UNIQUE, TempBed REAL, Voltage REAL, SamplintPoint INTEGER REFERENCES SamplingPoint (ID));

-- Table: RawMeasuresTemp
CREATE TABLE RawMeasuresTemp (ID INTEGER PRIMARY KEY AUTOINCREMENT, Date DATETIME, Temp1 REAL, Temp2 REAL, Temp3 REAL, Temp4 REAL, SamplintPoint INTEGER REFERENCES SamplingPoint (ID));
