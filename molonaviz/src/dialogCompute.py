...
From_DialogCompute = uic.loadUiType(os.path.join(os.path.dirname(__file__),"..","ui", "dialogCompute.ui"))[0]

class DialogCompute(QtWidgets.QDialog, From_DialogCompute):
    def __init__(self, maxdepth : int):
        """
        To create a DialogCompute instance, one must give the maximum depth of the river in meters. This can be obtained with the utils/utilsQueries:build_max_depth function.
        """
