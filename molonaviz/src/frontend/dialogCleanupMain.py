...
from src.frontend.dialogCleanPoints import DialogCleanPoints
from src.frontend.dialogScript import DialogScript
from src.backend.SPointCoordinator import SPointCoordinator

from src.utils.utils import displayCriticalMessage, databaseDateToDatetime
from src.Containers import SamplingPoint #Used only for type hints
...
class DialogCleanupMain(QtWidgets.QDialog, From_DialogCleanUpMain):
    ...
    """
    def __init__(self, coordinator : SPointCoordinator, point : SamplingPoint):
        """
        Constructor
        """
        ...
        self.point = point
        self.pointID = coordinator.samplingPointID
